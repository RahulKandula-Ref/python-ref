...
def rps_init():
    ...
    def play_rps():
        ...
        def print_game_stats():
            ...
            print(f"You lost: {computer_wins}")
        ...
        print("You chose : {playerchose} and python chose : {computerchose}"
                .format(playerchose=str(RPS(player)).replace('RPS.','').title(), 
                        computerchose=str(RPS(computer)).replace('RPS.','').title()))
        print(winner)
        print_game_stats()
